...
function randomFlag(randomID) {
    switch (randomID) {
        ...
        case 15:
            ...
            countryNameAlternativ = 'Bosnien Herzegowina'
            path = ('/Images/ba.png');
            break;
        ...
        case 33:
            ...
            path = ('/Images/bw.png');
            countryNameAlternativ = 'Botsuana'
            break;
        ...
        case 76:
            countryName = 'England'
            path = ('/Images/gb-eng.png');
            countryNameAlternativ = null
            break;

        case 77:
            countryName = 'Nordirland'
            path = ('/Images/gb-nir.png');
            countryNameAlternativ = null
            break;

        case 78:
            countryName = 'Schottland'
            path = ('/Images/gb-sct.png');
            countryNameAlternativ = null
            break;

        case 79:
            countryName = 'Wales'
            path = ('/Images/gb-wls.png');
            countryNameAlternativ = null
            break;
        ...
        case 208:
            ...
            countryNameAlternativ = 'Turks und Caicosinseln'
            path = ('/Images/tc.png');
            break;
